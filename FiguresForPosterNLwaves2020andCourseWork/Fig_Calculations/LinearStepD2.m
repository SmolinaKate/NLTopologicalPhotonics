function [ psiA, psiB ] = LinearStepD2( dt, psiA, psiB, k_x, k_y, eta, zeta)
%-------------------------------------------------------------------------%
N_x = length( k_x );
N_y = length( k_y );
psiA = fft2( psiA );
...
for iy = 1 : N_y
    for ix = 1 : N_x
        if( k_x( 1, ix ) == 0 && k_y( 1, iy ) == 0 )
            ...
            h=(k_x( 1, ix) -1i*k_y( 1, iy)...
             - eta*(k_x( 1, ix)+1i*k_y( 1, iy))^2 ...
             - zeta*(-1i*k_y( 1, iy)^3+k_x( 1, ix)^3-1i*k_y( 1, iy)*k_x( 1, ix)^2 ...
                     +k_y( 1, iy)^2*k_x( 1, ix)));
