...
%%%для сравнения со случаем BETA = 0 -- аналитические формулы, полученные
%%%без дисперсии
...
%%%в случае beta = 0 зависимость от интенсивности просто построить -- нужно использовать полученные ранее аналитические формулы        
kappa_x=-10:0.25:10;
I_0=0:0.25:3;
...
clear inc incr
%%%в случае beta != 0 зависимость от интенсивности не построить с помощью аналитической формулы -- надо считать для каждой итенсивности в лоб       
for i=1:1:length(I_0)
    i
    omega = M-g*I_0(i);
    psi_2=0;
